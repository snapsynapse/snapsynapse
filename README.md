...
True intelligence in the AI era is composite: human and machine capabilities combined into something neither can achieve alone. [PAICE.work](https://paice.work/) operationalizes this through an Aggregated Intelligence Posture (AIP) measured across three vectors, bounded by the weakest:
